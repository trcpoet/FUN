...
export const VENUE_FILL_COLOR_DEFAULT = "rgba(100, 116, 139, 0.10)"; // slate-500, very low
export const VENUE_FILL_COLOR_HOVER = "rgba(100, 116, 139, 0.16)";
/** Selected venue: warm but not alarm-yellow */
export const VENUE_FILL_COLOR_SELECTED = "rgba(217, 119, 6, 0.18)"; // amber-600 tint

export const VENUE_OUTLINE_COLOR_DEFAULT = "rgba(148, 163, 184, 0.28)";
export const VENUE_OUTLINE_COLOR_SELECTED = "rgba(251, 191, 36, 0.45)";
 ...
 */
export const VENUE_DOT_RADIUS_PX = 3.5;
...
export const VENUE_DOT_RADIUS_SELECTED_PX = 6.5;
export const VENUE_DOT_COLOR = "rgba(148, 163, 184, 0.85)";
export const VENUE_DOT_STROKE = "rgba(15, 23, 42, 0.65)";
export const VENUE_DOT_STROKE_WIDTH = 0.75;
export const VENUE_DOT_COLOR_SELECTED = "rgba(251, 191, 36, 0.95)";
...
export const VENUE_FOOTPRINT_MIN_ZOOM = 10.25;

/** Show venue center dots when zoom >= this (slightly earlier than full footprint). */
export const VENUE_DOT_MIN_ZOOM = 9;
