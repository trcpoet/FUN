    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[90] flex flex-col gap-4",
          "shadow-[var(--shadow-panel)] transition ease-[var(--ease-out)] data-[state=closed]:duration-[var(--dur-panel)] data-[state=open]:duration-[var(--dur-panel)]",
          side === "right" &&
