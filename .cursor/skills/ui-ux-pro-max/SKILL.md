...
name: ui-ux-pro-max
description: >-
  Provides design-system generation and searchable UI/UX intelligence (styles,
  palettes, typography, landing patterns, charts, stack guidelines). Use when
  the user requests UI, UX, landing pages, dashboards, design reviews, visual
  polish, accessibility, or implementation of interfaces in any supported stack.
---
...
**Script path (from project root):** `.cursor/skills/ui-ux-pro-max/scripts/search.py` — use this in all commands below.
